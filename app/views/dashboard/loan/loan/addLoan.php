                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="loanAmount" required="" class="form-control" id="loan" value="0"
                                       placeholder="1000">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input name="interest" value="0" class="form-control" id="interest" placeholder="5">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="interest">
                                            Interest Amount
                                        </label>
                                        <input  name="interestAmount" class="form-control" id="interestAmount" value="0">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="payable" required="" class="form-control" id="payableAmount" value="0">
                            </div>
                            ...
                            <div id="installDiv" style="display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="duration" id="duration" value="0" class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="perInstall" readonly="" id="perInstall" value="0" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="dynamic_date">
                                    <input name="date" id="datepicker" required="" value="<?php echo date('Y-m-d'); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="date">
