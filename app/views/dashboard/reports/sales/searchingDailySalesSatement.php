    ...
    if(!empty($info)){
        foreach ($info as $row) {
            ...
            <tr>
                ...
                <td><i class="<?php echo  (($netTotal != $row->payment_amount)?'badge bg-red':'badge bg-green'); ?>"   ><?php echo $payment=(!empty($row->payment_amount)?$row->payment_amount:'0.00'); $paymentAmt+=$row->payment_amount; ?></i></td>
