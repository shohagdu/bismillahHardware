                            ...
                            <table class="table-style-main" class="table table-striped" style="border:1px solid #d0d0d0;">
                                ...
                                <tbody id="tableDynamicPurchase">
                                    ...
                                    <tr>
                                        ...
                                        id="quantity_<?php echo $row->id; ?>" placeholder="Quantity" class="quantPurchase form-control only-number"></td>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" title="Delete" id="deleteRow_<?php echo $row->id; ?>"  class="deleteRowPurchase btn btn-danger  btn-sm"><i class="glyphicon glyphicon-remove"></i></a>
                    ...
                    <div class="box-footer text-right">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <button type="button"  class="btn btn-success btn-lg btn-block submit_btn"
                                        onclick="savePurchaseInfo()"><i class="glyphicon glyphicon-ok-sign"></i> Update</button>
                            </div>
                        </div>
                    </div>
                </form>
